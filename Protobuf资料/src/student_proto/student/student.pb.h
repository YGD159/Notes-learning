...
// required string number = 1;
inline bool Student_PhoneNumber::_internal_has_number() const {
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 Student::_internal_id() const {
  return id_;
}
...
inline void Student::_internal_set_id(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _has_bits_[0] |= 0x00000004u;
  id_ = value;
}
